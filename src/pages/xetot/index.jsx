...
import { FaUser, FaUserTie, FaCar, FaMotorcycle } from 'react-icons/fa';
import {
  Popover,
  PopoverContent,
  PopoverTrigger,
        ...
        <main className="flex flex-1 flex-col gap-4 p-4 lg:gap-6 lg:p-6">
          ...
          <header className="p-6 shadow-md">
            <div className="container mx-auto">
              <h1 className="text-3xl font-bold mb-6 ">Tìm kiếm Xe</h1>
              ...
              <div className="mb-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div
                    ...
                    onClick={() => onChangeVehicleType('Ô tô')}
                  >
                    <FaCar className="text-blue-500 mb-2" />
                    <h3 className="font-semibold">Ô tô</h3>
                  </div>
                  <div
                    className="p-4 rounded-md shadow-md hover:shadow-lg transition-shadow"
                    onClick={() => onChangeVehicleType('Xe máy')}
                  >
                    <FaMotorcycle className="text-green-500 mb-2" />
                    <h3 className="font-semibold">Xe máy</h3>
                  </div>
                </div>
              </div>
