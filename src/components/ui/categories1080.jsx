...
const sizescreens = [
  ...
  { label: "9 - 10.9 inch", value: "9-10.9" },
  { label: "11 - 12.9 inch", value: "11-12.9" },
  { label: "13 - 14.9 inch", value: "13-14.9" },
...
const CategoryPage1080 = () => {
  const setFormData = useAppStore((state) => state.setFormData);
  const setpage1080 = useAppStore((state) => state.setpage1080);
  const form = useForm({
                ...
                <Form {...form}>
                  ...
                  >
                    <TabsContent value="sale">
                      ...
                      />
                      <span>Chưa có apis của hãng để lấy dòng máy</span>
...
export default CategoryPage1080;
